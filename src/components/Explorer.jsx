...
const Explorer = ({
    ...
    return (
        <div
            className={`${isExplorerOpen ? "" : "hidden"
                    ...
                    <div className="content text-white select-none">
                        ...
                        <div className="bg-neutral-800 w-full h-12 border-neutral-700 border-b-[1.5px] mt-1 flex">
                            <div className="flex justify-around w-48 py-2">
                                <button
                                    class={`material-symbols-outlined font-extralight text-xl hover:bg-neutral-600 rounded-md hover:bg-opacity-50 ${handleDivClick === !0 ? "opacity-45" : "font-bold"
                                        }`}
                        ...
                        {aboutMe === true ? (
                            ...
                            <div className="flex flex-row h-full bg-neutral-900">
                                <div className="w-40 h-[100vh] pt-2 border-neutral-700 border-r-[1.5px] px-[2px]">
                                    <div
                                        className={`flex items-center pl-2.5 mr-8 text-xs w-full h-8 rounded-sm ${page === "About Me"
                                    ...
                                    <div
                                        className={`flex items-center pl-2.5 mr-8 text-xs w-full h-8 rounded-sm ${page === "Education"
                                            ? "bg-gray-200 bg-opacity-80 text-neutral-900"
                                            : "hover:bg-neutral-700 text-white"
                                            }`}
                                        onClick={() => {
                                    ...
                                    <div
                                        className={`flex items-center pl-2.5 mr-8 text-xs w-full h-8 rounded-sm ${page === "Skills"
                                            ? "bg-gray-200 bg-opacity-80 text-neutral-900"
                                            : "hover:bg-neutral-700 text-white"
                                            }`}
                                        onClick={() => {
                                    ...
                                    <div
                                        className={`flex items-center pl-2.5 mr-8 text-xs w-full h-8 rounded-sm ${page === "My Stuffs"
                                            ? "bg-gray-200 bg-opacity-80 text-neutral-900"
                                            : "hover:bg-neutral-700 text-white"
                                            }`}
                                        onClick={() => {
                                    ...
                                    <div
                                        className={`flex items-center pl-2.5 mr-8 text-xs w-full h-8 rounded-sm ${page === "Resume"
                                            ? "bg-gray-200 bg-opacity-80 text-neutral-900"
                                            : "hover:bg-neutral-700 text-white"
                                            }`}
                                        onClick={() => {
