...
const SkillItem = ({ skillItem, isTechStack = false, iconSize = 15 }) => {
    ...
    return (
        <div className="flex items-center ring-2 ring-neutral-700 bg-neutral-900 rounded-sm p-2 pl-3">
            ...
            <span
                className={`ml-2 text-neutral-400 text-selection hover:text-neutral-200 duration-150 ease-in-out cursor-pointer ${isTechStack ? "text-xs" : "text-sm"
                    }`}
            >
                {skillItem.name}
            </span>
                ...
                return (
                    <div className="hero min-h-auto justify-start">
                        <div className="hero-content flex-col lg:flex-row">
                            <img
                                src="https://i.imgur.com/1WQLl9c.jpeg"
